<h1 class="page-title">Comment on Request For Approval </h1>
    ...
    <div class="col-sm-6 col-sm-offset-3">
        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <label class="col-xs-12"><?php echo $lesson_plan['approv_request']; ?></label>
                <label class="col-xs-12">Comment :</label>
                <input type="hidden" name="approv_request_comment_date" value="<?php echo date('Y-m-d'); ?>">
                <textarea style="width: 100%" rows="10" name="approv_request_comment"> <?php echo $lesson_plan['approv_request_comment']; ?></textarea>
