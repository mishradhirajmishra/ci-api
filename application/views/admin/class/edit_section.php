    ...
    <div class="col-sm-8 col-sm-offset-2">
        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                    ...
                    <div class="col-xs-6">
                        <select  class="form-control" name="teacher_id"  >
                            ...
                            <?php foreach($emp_teacher as $row){?>
                                <option value="<?php $x=$this->admin_model->teacher_by_employee_id($row['employee_id']); echo $x['teacher_id'];?>"<?php if($x['teacher_id']==$section['teacher_id']){echo 'selected';}?>><?php echo $row['name'];?></option>
                            <?php } ?>
                        </select>
                ...
                <!--=====================================-->
                <div class="form-group">
                    <label class="col-xs-6">No of Compulsory Subjects :</label>
                    <div class="col-xs-6">
                        <input type="number" class="form-control" name="s_compulsory" value="<?php echo $section['s_compulsory']?>">
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                    <label class="col-xs-6">No of Optional Subjects :</label>
                    <div class="col-xs-6">
                        <input type="number" class="form-control" name="s_optional" value="<?php echo $section['s_optional']?>">
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                    <label class="col-xs-6">No of Required Subjects :</label>
                    <div class="col-xs-6">
                        <input type="number" class="form-control" name="s_required" value="<?php echo $section['s_required']?>">
                    </div>
                </div>
                <!--=====================================-->
...
<script>
    $(document).ready(function(e){
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url()?>index.php/admin/update_section',
