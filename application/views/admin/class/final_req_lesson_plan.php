<h1 class="page-title"> Comment on Final Request  </h1>
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('final_req_lesson_plan/<?php echo $lesson_plan['id'];?>')" ><i class="entypo-arrows-ccw"></i>Page Refresh</a></h6>
<hr>
<!--=====================================-->
    ...
    <div class="col-sm-6 col-sm-offset-3">
        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <input type="hidden" name="comp_request_comment_date" value="<?php echo date('Y-m-d'); ?>">

                <label class="col-xs-12"><?php echo $lesson_plan['comp_request']; ?></label>
                <label class="col-xs-12">Comment :</label>
                <textarea style="width: 100%" rows="10" name="comp_request_comment"> <?php echo $lesson_plan['comp_request_comment']; ?></textarea>
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                ...
                success: function(msg){
                    ...
                    loadview('final_req_lesson_plan/<?php echo $lesson_plan['id'];?>');
                },
                error: function(){
