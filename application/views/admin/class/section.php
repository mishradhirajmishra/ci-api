...
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('section')"><i class="entypo-arrows-ccw"></i> Page Refresh</a></h6>
<hr>
<!--=====================================-->
    ...
    <div class="col-sm-8 col-sm-offset-2">
     ...
     <option value="<?php $x=$this->admin_model->teacher_by_employee_id($row['employee_id']); echo $x['teacher_id'];?>"><?php echo $row['name'];?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                      <input type="number" class="form-control" name="s_compulsory">
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <input type="number" class="form-control" name="s_optional">
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <input type="number" class="form-control" name="s_required">
                    </div>
                </div>
                <!--=====================================-->
...
<script>
    $(document).ready(function(e){
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url()?>index.php/admin/add_section',
