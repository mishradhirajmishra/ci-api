        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "10"  class="form-control" name="contact_no">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "10"  class="form-control" name="emergency_contact_no">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "12"  class="form-control datepicker"  name="adhar_no">
                    </div>
                    <label class="col-sm-2">Pan No : </label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" maxlength="10" name="pan_no">
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="login_id" onblur="chkexist(this.value)"  >
                    </div>
...
<script>
    function chkexist(value) {
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url()?>index.php/admin/chk_employee_login_exist',
            data: {login_id:value},
            success: function(msg){
                if(msg==1) {
                    $('#subsmsg').html("<div class='alert alert-danger '><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <span style='color: red'> Login Id Already Exist. </span><div>");
                }
                else{
