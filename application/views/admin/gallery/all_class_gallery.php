<h1 class="page-title">All Class Gallery </h1>
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('all_class_gallery')" ><i class="entypo-arrows-ccw"></i> Page Refresh</a></h6>
<hr>
<!--=====================================-->
<?php //print_r("<pre>");?>
<?php // print_r($gallery);?>
...
<!---->
        <?php foreach($gallery as $row){?>
            <div class="col-sm-4" style="margin-bottom: 10px">
                ...
                <button id="view" style="float: right" class="btn btn-success" onclick="loadview('view_more_class_gal/<?php echo $row["id"]; ?>')">View More </button>
