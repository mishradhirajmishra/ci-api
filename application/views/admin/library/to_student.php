...
<h1 class="page-title"> Alot  Book To Student</h1>
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('issue_book_to_student/<?php echo $book['id'];?>')"><i class="entypo-arrows-ccw"></i> Page Refresh</a></h6>
<hr>
<!--=====================================-->
<?php //print_r($section);?>
<div class="guardian">
    <div class="col-sm-8 col-sm-offset-2">
        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <!--=====================================-->
                <div class="form-group">
                    <label class="col-xs-6">Section  :</label>
                    <div class="col-xs-6">
                            <select id="section" class="form-control" onchange="getStudent(value)" >
                ...
                <!--=====================================-->
                <div class="form-group">
                    <label class="col-xs-6">Student :</label>
                    <div class="col-xs-6">
