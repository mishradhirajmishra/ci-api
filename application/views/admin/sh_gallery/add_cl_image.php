...
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('sh_image/<?php echo $gallery["id"]; ?>')"><i class="entypo-arrows-ccw"></i> Page Refresh</a></h6>
<hr>
<hr>
<!--=====================================-->
<?php //print_r("<pre>");?>
    ...
    <div class="col-sm-6 col-sm-offset-3">
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart('admin/add_school_gal',$data) ?>
                <br>
                <!--=====================================-->
...
<script>
    function del(id){
     ...
     if(x==true){
         $.ajax({
             url: '<?php echo base_url()?>index.php/admin/delete_school_image',
             type:"POST",
             datatype:"json",
             data:{id:id},
             success: function (msg) {
                 ...
                 loadview('sh_image/<?php echo $gallery["id"]; ?>')
             },
...
<script>
    ...
    $(document).ready(function(e){
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url()?>index.php/admin/add_school_gal',
