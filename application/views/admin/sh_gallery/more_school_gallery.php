                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-left" role="menu">
                            <li><a   onclick="loadview('sh_image/<?php echo $row["id"]; ?>')"><i class="entypo-pencil"></i> Add More</a> </li>
                            <li><a   onclick="loadview('edit_school_gallery/<?php echo $row["id"]; ?>')"><i class="entypo-pencil"></i>  Edit </a> </li>
