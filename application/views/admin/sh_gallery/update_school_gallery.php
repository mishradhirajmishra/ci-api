<h1 class="page-title">Update School Gallery </h1>
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('edit_school_gallery/<?php echo $gallery["id"] ?>')" ><i class="entypo-arrows-ccw"></i> Page Refresh</a></h6>
<hr>
<!--=====================================-->
<div class="guardian">
    <div class="col-sm-6 col-sm-offset-3">
        ...
        <div class="panel-body">
            ...
            <?php echo form_open_multipart('admin/update_school_gallery',$data) ?>
            <br>
            <!--=====================================-->
...
<script>
    $(document).ready(function(e){
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url()?>index.php/admin/update_school_gallery',
                ...
                success: function(msg){
                    ...
                    loadview('edit_school_gallery/<?php echo $gallery["id"] ?>');
                },
                error: function(){
