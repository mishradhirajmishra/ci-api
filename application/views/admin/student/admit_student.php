        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                            <input type="number"  name="admission_no" class="form-control" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "12"  class="form-control" name="aadhaar_no" >
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="relation_to_guardian" value="" required>
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2"><input class="form-control"oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "6" name="resident_address_pin" ></div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" style="padding-left: 0px;">
                        ...
                        <div class="col-sm-1"><label >Pin No :</label></div>
                        <div class="col-sm-2"><input class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "6" name="correspond_address_pin" ></div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input  name="mobile_no_for_sms" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "10" class="form-control">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" style="padding-left: 0px;">
                        <div class="col-sm-4"><input class="form-control" type="text" name="emergency_contact_name_1" placeholder="Name" required></div>
                        <div class="col-sm-4"><input class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "10" name="emergency_contact_mobile_1" placeholder="Mobile No"  pattern="^\d{10}" required ></div>
                        <div class="col-sm-4"><input class="form-control" type="text" name="emergency_contact_relation_1" placeholder="Relationship" required></div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" style="padding-left: 0px;">
                        <div class="col-sm-4"><input class="form-control" type="text" name="emergency_contact_name_2" placeholder="Name" required></div>
                        <div class="col-sm-4"><input class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "10" name="emergency_contact_mobile_2" placeholder="Mobile No"  pattern="^\d{10}" required ></div>
                        <div class="col-sm-4"><input class="form-control" type="text" name="emergency_contact_relation_2" placeholder="Relationship" required></div>
                    </div>
...
<script>
    $(document).ready(function(e){
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url()?>index.php/admin/admit_student',
