        ...
        <div class="table-wrap">
            <table class="main-table">
                ...
                <tr>
                  ...
                  <?php
                  for($d=1; $d<=$day; $d++){
                      $att=$this->admin_model->get_assessment_individual($cl,$sec,$row['student_id'],$d,$month,$year);
                      echo "<td >";
                     ...
                     $tot1=floor(($tot/70)*100);
                      if($tot!=0) {
                          ?>
                          <a  data-toggle="modal" data-target="#myModal<?php echo $row['student_id'] ?>_<?php echo $d ?>">
                              <?php echo $tot1 ; ?>
                          </a>
                    ...
                    <?php
                     ...
                     ?>
                    <!--------------------------------------->
                    <div class="modal fade" id="myModal<?php echo $row['student_id'] ?>_<?php echo $d ?>" role="dialog">
                        <div class="modal-dialog modal-sm">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h2 class="modal-title"><?php echo $x;?></h2>
                                </div>
                                <div class="modal-body">
                             <?php
                             echo "<table>";
                             echo "<tr><td colspan='2' style='text-align: center'>".$d." ".date('F', mktime(0, 0, 0,  $month, 10))."</td></tr>";
                             echo "<tr><th>Punctuality</th><td>".$att['punctuality']."</td></tr>";
                             echo "<tr><th>Cleanliness</th><td>". $att['cleanliness']."</td></tr>";
                             echo "<tr><th>Attentiveness</th><td>".$att['attentiveness']."</td></tr>";
                             echo "<tr><th>Handwriting</th><td>".$att['handwriting']."</td></tr>";
                             echo "<tr><th>Interactive</th><td>". $att['interactive']."</td></tr>";
                             echo "<tr><th>Homework</th><td>". $att['homework']."</td></tr>";
                             echo "<tr><th>Classwork</th><td>".$att['classwork']."</td></tr>";
                             echo "<tr><th>Remark</th><td>".$att['remark']."</td></tr>";
                             echo "</table>";
