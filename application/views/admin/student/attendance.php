...
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('attendance')">Page Refresh</a></h6>
<hr>
<!--=====================================-->
<?php //print_r($cl);?>
...
<div class="col-xs-12">
    <div class="edate " style="text-align: center" >
        <?php echo date("j F , Y", strtotime($d));  ?><br>
         <span style="color: red">class</span> : <?php $xy=$this->admin_model->class_by_id($cl); echo $xy['name'];?> <span style="color: red">Section</span> : <?php echo $x['name'];?>
    </div>
</div>
<?php } ?>
<!--=====================================-->
...
<script>
    ...
    function send_sms(cl,sec,d) {
        $.ajax({
            url: '<?php echo base_url()?>index.php/admin/sms_attendance',
            type:"POST",
            datatype:"json",
...
/*        alert(id);
        ...
        alert(attr);*/
        $.ajax({
            url: '<?php echo base_url()?>index.php/admin/update_attendance',
            type:"POST",
            datatype:"json",
