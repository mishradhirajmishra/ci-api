...
<hr>
<a class="gold-bt" onclick="loadview('birth_certificate/<?php echo $student["student_id"];?>')"><i class="entypo-reply"></i>Prev</a>
<a class="gold-bt float-r"  onclick="loadview('medical_certificate/<?php echo $student["student_id"];?>')">Next<i class="entypo-forward"></i></a>
<hr>
