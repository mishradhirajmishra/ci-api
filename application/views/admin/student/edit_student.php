...
<a class="gold-bt float-r"  onclick="loadview('birth_certificate/<?php echo $student["student_id"];?>')">Next<i class="entypo-forward"></i></a>
<hr>
<!--=====================================-->
<?php // print_r($student); ?>
<div class="guardian">
        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "12"  class="form-control" name="aadhaar_no" value="<?php echo $student['aadhaar_no'];?>">
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select id="section" class="form-control" name="section">
                            <?php $section= $this->admin_model->section_by_id($student['section']); echo $section['name']; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" style="padding-left: 0px;">
                        ...
                        <div class="col-sm-2"><input value="<?php echo $student['resident_address_pin'] ?>" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "6"  name="resident_address_pin" ></div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" style="padding-left: 0px;">
                        ...
                        <div class="col-sm-1"><label >Pin No :</label></div>
                        <div class="col-sm-2"><input value="<?php echo $student['correspond_address_pin'] ?>" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "6"  name="correspond_address_pin" ></div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input value="<?php echo $student['mobile_no_for_sms'] ?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "10" name="mobile_no_for_sms" class="form-control">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" style="padding-left: 0px;">
                        ...
                        <div class="col-sm-4"><input value="<?php echo $student['emergency_contact_mobile_1'] ?>" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "10"  name="emergency_contact_mobile_1" placeholder="Mobile No"  pattern="^\d{10}" required ></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" style="padding-left: 0px;">
                        ...
                        <div class="col-sm-4"><input value="<?php echo $student['emergency_contact_mobile_2'] ?>" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "10"  name="emergency_contact_mobile_2" placeholder="Mobile No"  pattern="^\d{10}" required ></div>
...
<script>
    $(document).ready(function(e){
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url()?>index.php/admin/update_student',
