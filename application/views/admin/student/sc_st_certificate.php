...
<h6 class="cent-refresh"><a class="gold-bt"  onclick="loadview('sc_st_certificate/<?php echo $student["student_id"];?>')"><i class="entypo-arrows-ccw"></i> Page Refresh</a></h6>
<hr>
<a class="gold-bt" onclick="loadview('leaving_certificate/<?php echo $student["student_id"];?>')"><i class="entypo-reply"></i>Prev</a>
<a class="gold-bt float-r" onclick="loadview('st_subject/<?php echo $student["student_id"];?>')" >Next<i class="entypo-forward"></i> </a>
<hr>
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                ...
                success: function(msg){
                    loadview('sc_st_certificate/<?php echo $student["student_id"];?>');
