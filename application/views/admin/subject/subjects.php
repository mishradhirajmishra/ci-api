...
<h6 class="cent-refresh"><a class="gold-bt"  onclick="loadview('subjects')"><i class="entypo-arrows-ccw"></i> Page Refresh</a></h6>
<hr>
 ...
 <div class="col-sm-6 col-sm-offset-3">
         <div class="panel panel-success" data-collapsed="0">
             ...
             <div class="panel-body">
                 ...
                 <?php echo form_open_multipart('admin/add_subject_list',$data) ?>
                 <br>
    ...
    <table id="example">
      ...
      <?php $sn=1;foreach ($subject_list as $row){?>
          <tr>
              ...
              <td><a class="btn btn-success" onClick="loadview('edit_subjects/<?php echo $row['id']; ?>')" ><i class="entypo-pencil"></i>  <span class="hidden-xs">Edit</span></a></td>
          </tr>
      <?php }?>
...
<script>
    $(document).ready(function(e){
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url()?>index.php/admin/add_subject_list',
