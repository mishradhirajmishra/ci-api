                ...
                <td style="width:80px">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-left" role="menu">
                            <li><a onclick="loadview('edit_videos_gallery/<?php echo $row['id']; ?>')"><i class="entypo-plus-squared"></i>Edit</a></li>
                            <li><a  data-toggle="modal" data-target="#myModal<?php echo $row['id'] ?>"><i class="entypo-newspaper"></i>Play</a></li>
                        </ul>
                    </div>
                    <!---->
