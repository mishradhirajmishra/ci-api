            ...
            <div class="col-md-4 col-xl-4 chat"><div class="card mb-sm-3 mb-md-0 contacts_card">
                    ...
                    <div class="card-body contacts_body">
                        <ui class="contacts">
                            ...
                            <li class="add <?php if($id==$row['employee_id']){echo 'active';} ?>" onclick="loadview_chat('admin_teacher_chat_data/<?php echo $row['employee_id']; ?>/<?php echo $row['name']; ?>/<?php echo $row['employee_image']; ?>/7/0')">
