...
<table id="example"  >
    <thead>
    <tr><td style="width: 20%"> Id </td><td>Class Name</td><!--<td>Class Teacher</td>--><td>Status</td><td>Action</td></tr>
    </thead>
    <tbody>
    <?php foreach ( $all_class as $row) { ?>
        <tr>
            <td style="width: 20%" ><?php echo $row['class_id']?></td>
...
<script>
    $(document).ready(function(e){
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url()?>index.php/teacher/add_class',
