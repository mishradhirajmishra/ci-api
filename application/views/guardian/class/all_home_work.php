<h1 class="page-title"> All Home Work </h1>
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('all_home_work')"><i class="entypo-arrows-ccw"></i>Page Refresh</a></h6>
<hr>
...
<table id="example"  >
    ...
    <tr>
        ...
        <td style="width:80px"><a class="gold-bt" onclick="loadview('edit_home_work/<?php echo $row['id']; ?>')"><i class="entypo-pencil"></i>  <span class="hidden-xs">Edit</span></a></td>
