...
<div class="guardian">
    <div class="col-sm-8 col-sm-offset-2">
     ...
     <option value="<?php $x=$this->guardian_model->teacher_by_employee_id($row['employee_id']); echo $x['teacher_id'];?>"><?php echo $row['name'];?></option>
                            <?php } ?>
...
<table id="example"  >
    ...
    <?php foreach ( $all_section as $row) { ?>
        <tr>
            ...
            <td style="width: 20px" ><?php $x=$this->guardian_model->class_by_id($row['class_id']); echo $x['name']?></td>
           <td><?php $teach=$this->guardian_model->teacher_name($row['teacher_id']); print_r($teach);?></td>
