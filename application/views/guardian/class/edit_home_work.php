<h1 class="page-title"> Update Home Work </h1>
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('edit_home_work/<?php echo $class_work['id'];?>')" ><i class="entypo-arrows-ccw"></i>Page Refresh</a></h6>
<hr>
<!--=====================================-->
    ...
    <div class="col-sm-6 col-sm-offset-3">
        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart('teacher/update_home_work_data',$data) ?>
                <br>
                <!--=====================================-->
                ...
                <div class="form-group">
                    <label for="field-1" class="col-xs-4 control-label">Class :</label>
                     <?php $class=$this->guardian_model->class_by_id($class_work['class_id']); ?>
                    <div class="col-xs-8">
                ...
                <div class="form-group">
                    ...
                    <?php $sec=$this->guardian_model->section_by_id($class_work['section_id']); //print_r($sec);?>
                <div class="col-xs-8">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <?php $sub=$this->guardian_model->list_subjects_by_id($class_work['subject_id']);// print_r($sub);?>
...
<script>
    $(document).ready(function(e){
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url()?>index.php/teacher/update_home_work_data',
                ...
                success: function(msg){
                    ...
                    loadview('edit_home_work/<?php echo $class_work['id'];?>');
                },
                error: function(){
