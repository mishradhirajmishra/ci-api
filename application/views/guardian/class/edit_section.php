                    ...
                    <div class="col-xs-6">
                        <select  class="form-control" name="teacher_id"  >
                            ...
                            <?php foreach($emp_teacher as $row){?>
                                <option value="<?php $x=$this->guardian_model->teacher_by_employee_id($row['employee_id']); echo $x['teacher_id'];?>"<?php if($x['teacher_id']==$section['teacher_id']){echo 'selected';}?>><?php echo $row['name'];?></option>
                            <?php } ?>
                        </select>
