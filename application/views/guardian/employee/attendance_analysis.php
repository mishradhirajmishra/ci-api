...
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('emp_attendance_analysis')"><i class="entypo-arrows-ccw"></i> Page Refresh</a></h6>
<hr>
<!--=====================================-->
<?php //print_r($cl);?>
...
<script>
    function getdata(x) {
       ...
       loadview('emp_attendance_analysis/'+x);
    }
    function send_sms(d) {
        $.ajax({
