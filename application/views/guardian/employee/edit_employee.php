        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input value="<?php echo $employee['contact_no'];?>" type="number" class="form-control" name="contact_no">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input value="<?php echo $employee['emergency_contact_no'];?>" type="number" class="form-control" name="emergency_contact_no">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input value="<?php echo $employee['adhar_no'];?>" type="number" class="form-control datepicker"  name="adhar_no">
                    </div>
                    <label class="col-sm-2">Pan No : </label>
                    <div class="col-sm-4">
                        <input value="<?php echo $employee['pan_no'];?>" type="number" class="form-control" name="pan_no">
                    </div>
                </div>
                <!--=====================================-->
                <div class="form-group">
