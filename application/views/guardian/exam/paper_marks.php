...
<div class="col-sm-8 col-sm-offset-2" style="overflow-x:auto;">
    ...
    <table class="table" >
        <thead>
        <tr><td colspan="5">
                <h4 class="page-title" style="text-align: center;" >Exam : <?php $class= $this->guardian_model->list_all_exam_by_id( $exam_id); echo $class['name'] ?>
                    <span >&nbsp;&nbsp;&nbsp;&nbsp; Class : <?php $class= $this->guardian_model->class_by_id($class_id); echo $class['name'] ?></span>
                    <span >&nbsp;&nbsp;&nbsp;&nbsp; Section : <?php $section= $this->guardian_model->section_by_id($section_id); echo $section['name']; ?></span>
                    <span >&nbsp;&nbsp;&nbsp;&nbsp; Subject : <?php $section= $this->guardian_model->list_subjects_by_id($subject_id); echo $section['name']; ?></span>
                    <span >&nbsp;&nbsp;&nbsp;&nbsp; Paper : <?php $section= $this->guardian_model->list_subject_option_by_id($paper_id); echo $section['name']; ?></span>
                </h4>
        </td></tr>
        ...
        <?php $sn=1;foreach ( $all_data as $row) {; ?>
            <tr>
                ...
                <td style="width: 20px;background-color: darkgoldenrod;color: white;vertical-align: middle;" ><?php $stu=$this->guardian_model->student_name_by_id($row['student_id']) ; print_r($stu); ?></td>
