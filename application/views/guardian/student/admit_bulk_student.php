            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" style="padding-left: 0px;">
                        ...
                        <div class="col-sm-4"><input class="form-control" type="number" name="emergency_contact_mobile_1" placeholder="Mobile No" ></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" style="padding-left: 0px;">
                        ...
                        <div class="col-sm-4"><input class="form-control" type="number" name="emergency_contact_mobile_2" placeholder="Mobile No" ></div>
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                ...
                success: function(msg){
                    ...
                    $('#subsmsg').html("<div class='alert alert-danger '> One record inserted successfully. <span style='color: red'> Click on reset button to add new Guardian</span><div>");
