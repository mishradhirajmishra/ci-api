...
<?php //print_r($cl);?>
    ...
    <div class="col-xs-12" style="border: 1px solid white;">
        ...
        <div class="col-sm-2 col-xs-8" style="margin-bottom: 10px">
            <?php $x=$this->guardian_model->class_by_id($cl); ?>
...
<div class="col-xs-12">
    <div class="edate " style="text-align: center" >
        <?php echo date("j F , Y", strtotime($d));  ?><br>
         <span style="color: red">class</span> : <?php $xy=$this->guardian_model->class_by_id($cl); echo $xy['name'];?> <span style="color: red">Section</span> : <?php echo $x['name'];?>
    </div>
</div>
<?php } ?>
<!--=====================================-->
        ...
        <div class="table-wrap">
            <table class="main-table">
                ...
                <tr>
                    ...
                    <th class="fixed-side fixed" ><?php $x=$this->guardian_model->student_name($row['student_id']); echo $x ?>
                    </th>
                    <td >
