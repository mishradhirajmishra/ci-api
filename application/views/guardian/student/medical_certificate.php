...
<hr>
<a class="gold-bt" onclick="loadview('character_certificate/<?php echo $student["student_id"];?>')">Prev</a>
<a class="gold-bt float-r"  onclick="loadview('leaving_certificate/<?php echo $student["student_id"];?>')">Next</a>
<hr>
