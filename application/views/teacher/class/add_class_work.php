<h1 class="page-title"> Add Class Work </h1>
<h6 class="cent-refresh"><a class="gold-bt" onclick="loadview('add_class_work/<?php echo $s_period['id'];?>')" ><i class="entypo-arrows-ccw"></i>Page Refresh</a></h6>
<hr>
<!--=====================================-->
...
<script>
    $(document).ready(function(e){
        ...
        $("#fupForm").on('submit', function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url()?>index.php/teacher/add_class_work_data',
                data: new FormData(this),
                contentType: false,
                cache: false,
                processData:false,
                success: function(msg){
                    loadview('add_class_work');
