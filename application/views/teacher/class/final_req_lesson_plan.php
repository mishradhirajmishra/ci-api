<h1 class="page-title"> Final Request  </h1>
    ...
    <div class="col-sm-6 col-sm-offset-3">
        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <input type="hidden" name="comp_request_date" value="<?php echo date('Y-m-d'); ?>">

                <label class="col-xs-12">Request :</label>
                <textarea style="width: 100%" rows="10" name="comp_request"> <?php echo $lesson_plan['comp_request']; ?></textarea>
