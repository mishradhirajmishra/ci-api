    ...
    <table id="example"  >
        ...
        <?php foreach ( $all_period as $row) { ?>
            ...
            <tr>
                ...
                <td style="width: 80px"><?php $exam=$this->teacher_model->list_all_exam_allowed_section($row['class_id'],$row['section_id']);?>
                    <select class="form-control" name="exam_id" id="exam_id<?php echo $row['id']?>" value="" onchange="getpaper(value,<?php echo $row['class_id'];?>,<?php echo $row['section_id'];?>,<?php echo $row['subject'];?>,<?php echo $row['id'];?>);">
                        ...
                        <option value="<?php echo $col['exam_id']?>"><?php $exam1=$this->teacher_model->exam_by_id($col['exam_id']); echo $exam1['name'] ;?></option>
                        <?php }?>
                    </select>
                </td>
                <td style="width: 80px">
