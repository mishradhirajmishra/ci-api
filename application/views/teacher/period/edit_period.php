                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select id="section" class="form-control" name="section_id">
                            <option value="<?php echo $per['section_id']?>"><?php  $section=$this->teacher_model->section_by_id($per['section_id']); echo $section['name']?></option>
                        </select>
                    </div>
                </div>
                <!--=====================================-->
                    ...
                    <div class="col-xs-8">
                        <select class="form-control" name="teacher_id" onchange="detail(value)" required >
                            ...
                            <?php foreach($emp_teacher as $row){?>
                                <option value="<?php $x=$this->teacher_model->teacher_by_employee_id($row['employee_id']); echo $x['teacher_id'];?>"  <?php if($x['teacher_id']==$per['teacher_id']){ echo 'selected';} ?>><?php echo $row['name'];?></option>
                            <?php } ?>
                        </select>
