...
<table id="example">
    ...
    <?php foreach($students as $row){?>
        <tr >
            ...
            <td><?php $class= $this->teacher_model->class_by_id($row['class']); echo $class['name'] ?></td>
            <td><?php $section= $this->teacher_model->section_by_id($row['section']); echo $section['name']; ?></td>
            <td><?php $guardian= $this->teacher_model->list_guardian_by_id($row['guardian']); echo $guardian['guardian_name']; ?></td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <table class="table table-responsive">
                                    ...
                                    <tr><th>Class</th><td><?php $class= $this->teacher_model->class_by_id($row['class']); echo $class['name'] ?></tr>
                                    <tr><th>Section</th><td><?php $section= $this->teacher_model->section_by_id($row['section']); echo $section['name']; ?></tr>
                                    <tr><th>Nationality</th><td><?php echo $row['nationality'] ?></tr>
                                    <tr><th>Religion</th><td><?php echo $row['Religion'] ?></tr>
                                    <tr><th>Guardian</th><td><?php $guardian= $this->teacher_model->list_guardian_by_id($row['guardian']); echo $guardian['guardian_name']; ?></tr>
