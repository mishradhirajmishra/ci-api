...
<hr>
<a class="gold-bt"  onclick="loadview('edit_student/<?php echo $student["student_id"];?>')">Prev</a>
<a class="gold-bt float-r"  onclick="loadview('character_certificate/<?php echo $student["student_id"];?>')">Next</a>
<hr>
