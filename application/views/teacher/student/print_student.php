...
<div class="col-sm-12" id="guardian">
    ...
    <table class="table table-responsive">
        ...
        <tr><th>Class</th><td><?php $class= $this->teacher_model->class_by_id($student['class']); echo $class['name'] ?></tr>
        <tr><th>Section</th><td><?php $section= $this->teacher_model->section_by_id($student['section']); echo $section['name']; ?></tr>
        <tr><th>Nationality</th><td><?php echo $student['nationality'] ?></tr>
        <tr><th>Religion</th><td><?php echo $student['Religion'] ?></tr>
        <tr><th>Guardian</th><td><?php $guardian= $this->teacher_model->list_guardian_by_id($student['guardian']); echo $guardian['guardian_name']; ?></tr>
